from registro_vehiculos.services import crear_vehiculo,crear_chofer,crear_registro_contable,obtener_vehiculo,obtener_chofer,asignar_chofer_a_vehiculo,eliminar_chofer,imprimir_datos_vehiculos
